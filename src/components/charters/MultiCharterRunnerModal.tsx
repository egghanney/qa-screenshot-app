          ...
          <div className="bg-qa-white px-3.5 sm:px-6 py-2.5 sm:py-3 border-b border-qa-border flex flex-col md:flex-row md:items-center justify-between gap-2.5 sm:gap-4 shrink-0 shadow-2xs">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 sm:gap-4">
              ...
              <div className="flex items-center gap-1.5 text-[10px] sm:text-[11px] font-mono overflow-x-auto no-scrollbar pb-0.5 sm:pb-0">
                <span className="px-2.5 py-0.5 rounded-pill bg-emerald-100 text-emerald-800 font-bold border border-emerald-300 shrink-0">
                  PASS: {counters.passed}
                </span>
                <span className="px-2.5 py-0.5 rounded-pill bg-rose-100 text-rose-800 font-bold border border-rose-300 shrink-0">
                  FAIL: {counters.failed}
                </span>
                <span className="px-2.5 py-0.5 rounded-pill bg-amber-100 text-amber-800 font-bold border border-amber-300 shrink-0">
                  BLOCK: {counters.blocked}
                </span>
                <span className="px-2.5 py-0.5 rounded-pill bg-qa-surface text-slate-700 font-medium border border-qa-border shrink-0">
                        ...
                        activeCharterScenarios.map((scenario) => {
                          return (
                            <div key={scenario.id} className="p-3.5 sm:p-4 bg-white hover:bg-slate-50/50 space-y-3">
                              ...
                              {/* 1-Click Thumb-Friendly Quick Action Buttons (Min 44px height, Pill integrity) */}
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    {scenario.media_url && (
                                      <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="shrink-0 min-h-[38px] px-3.5 py-1.5 rounded-pill bg-slate-100 hover:bg-slate-200 text-indigo-700 text-xs font-semibold flex items-center gap-1 font-mono"
                                      >
