...
export function MultiCharterRunnerModal({
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-slate-50 text-txt-primary animate-in fade-in duration-150 overflow-hidden w-screen h-screen">
      ...
      <header className="bg-dark-chassis text-white px-6 py-3.5 flex flex-wrap items-center justify-between gap-3 border-b border-dark-secondary shrink-0 shadow-md">
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-3 py-1.5 rounded-pill bg-dark-secondary hover:bg-dark-tertiary text-txt-muted hover:text-white flex items-center gap-1.5 text-xs font-semibold transition border border-dark-tertiary shadow-2xs"
          ...
          <div className="h-5 w-px bg-dark-secondary hidden sm:block" />

          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-full bg-neon text-dark-chassis flex items-center justify-center font-bold text-xs shadow-sm">
              <Play className="w-3.5 h-3.5 fill-dark-chassis" />
            </div>
            <div>
          ...
          {phase === 'running' && (
            <>
              ...
              >
                ...
                <span className="hidden sm:inline">Change Scope</span>
              </button>
            </>
          )}
      ...
      {phase === 'running' && (
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="bg-qa-white px-6 py-3 border-b border-qa-border flex flex-wrap items-center justify-between gap-4 shrink-0 shadow-2xs">
            <div className="flex items-center gap-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-bold text-dark-chassis">
                    Execution Progress: {counters.executed} of {counters.total}
                  </span>
              ...
              <div className="flex items-center gap-1.5 text-[11px] font-mono">
                ...
                <span className="px-2 py-0.5 rounded-md bg-qa-surface text-slate-700 font-medium border border-qa-border">
            ...
            <div className="flex items-center gap-1.5 bg-qa-warm p-1 rounded-pill border border-qa-border">
              <button
                ...
                className={`px-3.5 py-1 rounded-pill text-xs font-semibold transition flex items-center gap-1.5 ${
                  viewMode === 'charter'
                    ? 'bg-dark-chassis text-white shadow-2xs'
                    : 'text-txt-muted hover:text-dark-chassis'
                }`}
            ...
            <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
              ...
              <div className="px-6 py-2.5 bg-clinical-warm/80 border-b border-clinical-border flex flex-wrap items-center justify-between gap-3 shrink-0">
                ...
                <div className="flex items-center gap-1 bg-white p-1 rounded-full border border-clinical-border shadow-2xs text-xs">
                  <span className="text-[10px] font-mono text-txt-muted px-2 uppercase font-bold">Filter:</span>
                  <button
              ...
              <div className="pt-4 border-t border-qa-border flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3.5 py-2 rounded-pill bg-qa-white hover:bg-qa-warm text-dark-chassis text-xs font-bold border border-qa-border transition flex items-center gap-1 disabled:opacity-40"
                  >
          ...
          {viewMode === 'history' && (
            <div className="p-6 md:p-8 overflow-y-auto flex-1 space-y-4 max-w-6xl w-full mx-auto">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
